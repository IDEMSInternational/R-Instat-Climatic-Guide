...
popular form of display by National Met Services (NMSs) for these data.
  ...
  ***Fig. 16.1a***                                       ***Fig. 16.1b***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.1a.png){width="2.6243372703412073in"   ![](figures/Fig16.1b.png){width="3.3880194663167105in"
...
2 \* 3.14 = 6.28).
  ...
  -------------------------------------------------------------------------------------------------------------
  ***Fig. 16.2a Data from circular package***                                       ***Fig. 16.2b Adding a date variable***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.2a.png){width="2.5966491688538933in"   ![](figures/Fig16.2b.png){width="3.488678915135608in"
  height="3.298924978127734in"}                          height="3.357030839895013in"}
...
16.2a.
  ...
  ***Fig. 16.2c***                                       ***Fig. 16.2d***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.2c.png){width="2.5924682852143484in"   ![](figures/Fig16.2d.png){width="3.5642311898512684in"
...
radians, or 135 degrees, as shown in Fig. 16.2d
  ...
  -------------------------------------------------------------------------------------------------------------
  ***Fig. 16.2e A circular histogram of the wind data***                                       ***Fig. 16.2f The circular keyboard***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.2e.png){width="2.557014435695538in"   ![](figures/Fig16.2f.png){width="3.5340409011373577in"
  height="2.6285608048993874in"}                         height="1.9491097987751531in"}
...
16.2h. In this case you need to replace the word "radians" by "degrees".
  ...
  ***Fig. 16.2g***                                       ***Fig. 16.2h***
  ------------------------------------------------------ -----------------------------------------------------
  ![](figures/Fig16.2g.png){width="3.5270439632545934in"   ![](figures/Fig16.2h.png){width="2.536725721784777in"
  height="2.5473108048993875in"}                         height="2.549666447944007in"}

  ------------------------------------------------------------------------------------------------------------

It seems that nothing has happened. But now press the
![](figures/Fig3.1h.png){width="0.2736023622047244in"
...
height="0.23361767279090115in"} to close the metadata window.
  ...
  ***Fig. 16.2i***
  -----------------------------------------------------------------------
  ![](figures/Fig16.2i.png){width="4.6506572615923005in"
...
Output window, Fig. 16.2k.
  ...
  ***Fig. 16.2j***                                       ***Fig. 16.2k***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.2j.png){width="3.1713484251968502in"   ![](figures/Fig16.2k.png){width="2.8102821522309713in"
...
16.2d that has ignored the circular nature of the data (and is wrong!)
  ...
  ***Fig. 16.2l***                                     ***Fig. 16.2m***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.2l.png){width="2.40545384951881in"   ![](figures/Fig16.2m.png){width="3.680741469816273in"
...
16.2n. Round the circle they are not very spread out.
  ...
  ***Fig. 16.2n***                                     ***Fig. 16.2o***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.2n.png){width="3.098264435695538in"   ![](figures/Fig16.2o.png){width="2.7570877077865266in"
...
parameters and is symmetrical about the circular mean.
  ...
  ----------------------------------------------------------------------------------------------------------
  ***Fig. 16.2p Examples of von Mises distributions***                                     ***Fig. 16.2q***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.2p.png){width="2.939744094488189in"   ![](figures/Fig16.2q.png){width="3.070688976377953in"
  height="2.360246062992126in"}                       height="2.5898534558180226in"}
...
Column Summaries*** as shown in Fig. 16.2m and Fig. 16.2n.
  ...
  ----------------------------------------------------------------------------------------------------------
  ***Fig. 16.2r***                                     ***Fig. 16.2s Circular sub-dialogue***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.2r.png){width="2.9925721784776904in"   ![](figures/Fig16.2s.png){width="2.902083333333333in"
  height="3.2901760717410324in"}                       height="3.334722222222222in"}
...
was just over 1.
  ...
  ***Fig. 16.2t***                                     ***Fig. 16.2u***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.2t.png){width="3.054669728783902in"   ![](figures/Fig16.2u.png){width="2.9363615485564303in"
...
circular element, i.e. the wind directions in the variable called wd.
  ...
  ----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3a Wind and pollution data***                                     ***Fig. 16.3b Checking the wind data***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3a.png){width="2.9951706036745405in"   ![](figures/Fig16.3b.png){width="2.5270352143482064in"
...
Tidy and Examine \> One Variable Frequencies*** dialogue, Fig. 16.3b.
  ...
  ----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3c Different values in the wd variable***                                     ***Fig. 16.3d Duplicating the wind variable***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3c.png){width="2.902083333333333in"   ![](figures/Fig16.3d.png){width="3.140196850393701in"
...
to avoid overwriting the original data in wd.
  ...
  ----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3e Replace 0 by missing***                                     ***Fig. 16.3f Results from summary of 4 variables***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3e.png){width="2.243173665791776in"   ![](figures/Fig16.3f.png){width="3.8288287401574803in"
  height="2.243173665791776in"}                       height="1.8698742344706911in"}
...
here the grouping for the histogram is probably to blame.
  ...
  ***Fig. 16.3g***                                      ***Fig. 16.3h***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3g.png){width="2.882574365704287in"   ![](figures/Fig16.3h.png){width="3.096017060367454in"
...
more colourful at the same time.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3i Setting bins in the histogram***                                      ***Fig. 16.3j Ordinary histogram***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3i.png){width="2.63702646544182in"   ![](figures/Fig16.3j.png){width="3.3948250218722658in"
  height="3.539001531058618in"}                        height="3.5374660979877515in"}
...
***Coordinates*** tab in Fig. 16.3k and specify ***polar*** coordinates.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3k***                                      ***Fig. 16.3l Histogram as a circular plot***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3k.png){width="2.8561056430446192in"   ![](figures/Fig16.3l.png){width="2.7276979440069993in"
...
the result into a variable called ***hour***.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3m Making an hour variable***                                      ***Fig. 16.3n Making a 3-hour variable***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3m.png){width="2.794021216097988in"   ![](figures/Fig16.3n.png){width="3.1914271653543307in"
...
limits*** to ***-600 to 600***.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3o***                                      ***Fig. 16.3p Circular histogram with facets***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3o.png){width="2.160592738407699in"   ![](figures/Fig16.3p.png){width="3.889770341207349in"
  height="2.357010061242345in"}                        height="2.695122484689414in"}
...
16.3q to make a Date column from the date-time column.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3q***                                      ***Fig. 16.3r Defining a variable as circular***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3q.png){width="2.9268219597550305in"   ![](figures/Fig16.3r.png){width="3.889770341207349in"
  height="3.5730719597550307in"}                        height="2.695122484689414in"}
...
variable*** as ***circular, Fig 16.4r***.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.3s Calculating circular summaries***                                      ***Fig. 16.3t***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3s.png){width="2.861185476815398in"   ![](figures/Fig16.3t.png){width="3.889770341207349in"
  height="2.8767071303587053in"}                        height="2.695122484689414in"}
...
hours are available.
  ...
  ***Fig. 16.3u***                                      ***Fig. 16.3v***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3u.png){width="2.6617049431321087in"   ![](figures/Fig16.3v.png){width="3.889770341207349in"
  height="3.3775021872265967in"}                        height="2.695122484689414in"}
  ...
  ***Fig. 16.3w***                                      ***Fig. 16.3x***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.3w.png){width="2.6617049431321087in"   ![](figures/Fig16.3x.png){width="3.889770341207349in"
  height="3.3775021872265967in"}                        height="2.695122484689414in"}
...
indication of bimodality.
  ...
  ***Fig. 16.3y***
  -----------------------------------------------------------------------
  ![](figures/Fig16.3y.png){width="6.120766622922135in"
...
results from the hourly data.
  ...
  -----------------------------------------------------------------------------------------------------------
  ***Fig. 16.4a Default wind rose***                                      ***Fig. 16.4b Default wind-rose***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.4a.png){width="2.7000404636920385in"   ![](figures/Fig16.4b.png){width="3.279529746281715in"
...
theme to Classical. Then choose the Colours tab and try Red-Yellow-Blue.
  ...
  ***Fig. 16.4c Windrose Options***                     ***Fig. 16.4d***
  ----------------------------------------------------- ------------------------------------------------------
  ![](figures/Fig16.4c.png){width="2.305673665791776in"   ![](figures/Fig16.4d.png){width="3.5765726159230096in"
...
(Fig. 16.4c) and the colours to Qualitative \> Dark2 gives Fig. 16.4f.
  ...
  ***Fig. 16.4e***                                     ***Fig. 16.4f***
  ---------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.4e.png){width="2.99290791776028in"   ![](figures/Fig16.4f.png){width="2.940764435695538in"
...
+=======================================================================+
| ![](figures/Fig16.4g.png){width="6.1262849956255465in"                |
...
The daily data are shown in Fig. 16.4h.
  ...
  ***Fig. 16.4h***                                       ***Fig. 16.4i***
  ------------------------------------------------------ -----------------------------------------------------
  ![](figures/Fig16.4h.png){width="3.3471358267716536in"   ![](figures/Fig16.4i.png){width="2.649762685914261in"
  ...
  ***Fig. 16.4j***
  -----------------------------------------------------------------------
  ![](figures/Fig16.4j.png){width="6.124628171478565in"
...
use directions, i.e. N, NNE, etc.
  ...
  ***Fig. 16.5a***                                       ***Fig. 16.5b***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.5a.png){width="2.9411942257217847in"   ![](figures/Fig16.5b.png){width="2.9109405074365706in"
...
of the wind speeds by these 12 directions.
  ...
  ***Fig. 16.5c***                                       ***Fig. 16.5d Maximum daily wind speeds, by
                                                         direction***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.5c.png){width="2.5343930446194225in"   ![](figures/Fig16.5d.png){width="3.4517311898512686in"
...
Fig. 16.5e.
  ...
  ***Fig. 16.5e***                                       ***Fig. 16.5f***
  ------------------------------------------------------ ------------------------------------------------------
  ![](figures/Fig16.5e.png){width="2.9485433070866143in"   ![](figures/Fig16.5f.png){width="2.9764621609798776in"
...
while Fig. 16.5h adds the jittered points to the diagram.
  ...
  ***Fig. 16.5g***                                      ***Fig. 16.5h***
  ----------------------------------------------------- -----------------------------------------------------
  ![](figures/Fig16.5g.png){width="2.992658573928259in"   ![](figures/Fig16.5h.png){width="2.977374234470691in"
...
(rather than the maximums, shown above) for each month.
  ...
  ***Fig. 16.5i***
  -----------------------------------------------------------------------
  ![](figures/Fig16.5i.png){width="6.155880358705162in"
...
easier to make from Fig. 16.5i.
  ...
  ***Fig. 16.5j***
  -----------------------------------------------------------------------
  ![](figures/Fig16.5j.png){width="6.137919947506561in"
